    ...
    <div className="flex-1 h-full flex flex-col items-center px-3 sm:px-6 pb-6 pb-safe overflow-y-auto overscroll-y-contain">
      ...
      <div className="w-full max-w-[720px]">
        ...
        <div className="relative bg-cc-card border border-cc-border rounded-2xl shadow-sm">
          ...
          />
          {/* Context badges (Linear issue, attachments) — inside card to avoid external shift */}
          {(selectedLinearIssue || attachments.length > 0) && (
          ...
          {attachmentError && (
            <div className="px-4 pt-2 text-[11px] text-cc-error">{attachmentError}</div>
          )}
          <textarea
            ref={textareaRef}
            value={text}
